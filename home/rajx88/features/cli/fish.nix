...
in {
  ...
  programs.fish = {
    ...
    interactiveShellInit = ''
      # Aura theme colors for fish syntax highlighting
      if not set -q __fish_aura_applied
        set -U fish_color_normal edecee
        set -U fish_color_command a277ff
        set -U fish_color_keyword f694ff
        set -U fish_color_quote 61ffca
        set -U fish_color_redirection f694ff
        set -U fish_color_end a277ff
        set -U fish_color_error ff6767
        set -U fish_color_param 82e2ff
